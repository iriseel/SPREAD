...
const texts = [
    "<p>SPREAD VOL. II<br>" +
        "Yale School of Art Graphic Design MFA ‘24 Appendix Shows</p>" +
        "<p>June 14-30, 2024<br>" +
        "New York City" +
        "<div class='block'>" +
        ...
        "<p>SPREAD VOL. II features the work of the 2024 MFA cohort in Graphic Design presented in conversation with one another, reproducing and remixing the culmination of our time––our thesis books––in order to amplify our connections and expand the definition of graphic design as a way of relating. The polysemic title also functions as an invitation: as a verb, SPREAD further expresses our collective desire to share this work outside of the graphic design program through traveling presentations in New York City and beyond.</p>" +
        "</div>" +
        "<p>Please join the celebrations with the recent MFA graduates Julio Correa Estrada, Davy Dai, Sara Duell, Kayla Hawkins, Darnell Henderson, Junyan Hu, Claire Hungerford, Kaming Lee, Siri Lee, Daedalus Guoning Li, Lobbin Chenhao Liu, Xinyi Liu, Neeta Patel, Orlando Porras, Qiang Wang, June Lihua Yu, and Ken Wenrui Zhao.</p>",

    "<ul>Index Space</ul>" +
        "<li>120 Walker St 3rd Floor, New York, NY</li>" +
        "<li>June 14–16, 12–4pm</li>" +
        "<li>Reception with live performances, June 14, 6-9pm</li>" +
        "<br>" +
    ...
    "<h1>Purchase</h1>" +
        ...
        "<p>Currently available for presale at a discounted price.</p>" +
        "<div class='block'>" +
        "<p>Shipping after June 14.<br>" +
        "All the proceeds fund the appendix shows in NYC and beyond.</p>" +
        "</div>",
...
function populatePages() {
    ...
    const randomIndex1 = getRandomIndexWithProbability(
        0,
        contentsLeft.length,
        [26, 27, 28],
        0.3
    ...
    if (randomIndex1 === 26 || randomIndex1 === 27 || randomIndex1 === 28) {
        do {
            randomIndex2 = getRandomIndexWithProbability(
                0,
                contentsRight.length,
                [26, 27, 28],
                0.3
            );
...
purchaseBtn.addEventListener("click", () => showPopup(2));
